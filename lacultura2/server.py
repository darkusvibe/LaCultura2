...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # e.g. ["http://127.0.0.1:8000", "https://eloquent-squirrel-e3c9e0.netlify.app/"]
...
HF_TOKEN = "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"  # 🔥 Replace with your actual token
